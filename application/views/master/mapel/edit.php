<div class="modal fade" id="modal_edit">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<?= form_open('master/Matapelajaran/update', ['id' => 'edit', 'class' => 'form_edit'], ['kode' => $data['kode_matapelajaran']]) ?>
			<div class="modal-body">
				<div class="form-group">
					<label>Kode Mata Pelajaran</label>
					<input type="text" name="kode" class="form-control" value="<?= $data['kode_matapelajaran'] ?>" readonly="disabled">
					<span class="error kode text-red"></span>
				</div>

				<div class="form-group">
					<label>Nama Mata Pelajaran</label>
					<input type="text" name="nama" class="form-control" value="<?= $data['nama_matapelajaran'] ?>">
