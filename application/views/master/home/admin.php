...
<div class="row ">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>Data Matapelajaran</h3>
              <p>_</p>
            </div>
            <div class="icon">
              <i class="fa fa-list"></i>
            </div>
            <a href="<?= site_url('mapel') ?>" class="small-box-footer">Lihat Selengkapnya<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <!-- ./col -->
...
<div class="row ">
        ...
        <div class="col-lg-3 col-xs-3">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?= site_url('pangkat') ?>" class="small-box-footer">Lihat Selengkapnya<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
</div>
