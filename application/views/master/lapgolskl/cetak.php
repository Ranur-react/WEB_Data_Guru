...
<body onload="window.print()">
	<h1 align="center">Laporan Data Guru berdasarkan Golongan per Sekolah
		 <br>Kecamatan Padang Timur</h1>
	<h3 align="center">Kota Padang</h3>
	<table align="center" width="60%" border="0">
	<tr>
		<td width="20%">Kode/Nama Sekolah</td>
		<td align="right" width="20%">: <?= $dsikola['kode_sekolah']; ?>-<?=  $dsikola['nama_sekolah']  ?></td>
		<td align="right" width="60%"> </td>
	</tr>
		<tr>
		<td width="20%">Status Golongan</td>
