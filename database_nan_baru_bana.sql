...
insert  into `tb_golongan`(`kode_golongan`,`nama_golongan`) values ('GL01','Kepala Sekolah'),('GL02','Guru Kelas');
...
insert  into `tb_guru`(`nip_guru`,`nama_guru`,`tmp_lahir_guru`,`tgl_lahir_guru`,`alamat_guru`,`telp_guru`,`jenkel_guru`,`agama_guru`,`status_guru`,`jabatan_guru`,`masa_jabatan_guru`,`ren_pensiun_guru`,`nip_lama_guru`,`nama_diklat_guru`,`thn_diklat_guru`,`kode_sekolah_guru`,`kode_jenis_guru`,`tgl_diangkat_guru`,`no_sk_guru`,`kode_golongan_guru`,`kode_pegawai_guru`) values ('12312','AB','Medan','1998-02-28','Padang','8789','L','Islam','Menikah','Guru','2',NULL,NULL,'KLS','2011','SKL1','MP01',NULL,'123123','GL01','PG-01'),('NIP01','Rahmat','Padang','2020-05-07','Kataping','081246','L','Islam','PNS','Guru Kelas','8 Tahun',2,'N01','5 Bulan','2002','SKL2','MP01','2020-05-28','SK01','GL02','PG-02'),('NIP02','Mawar','Solok','2020-05-30','Alahan Panjang','094756','P','Kong Hucu','Kawin','Kepala Sekolah','6 Tahun',4,'N02','7 bulan','2001','SKL1','MP01','2020-05-13','SK02','GL01','PG-01');
...
insert  into `tb_kelurahan`(`kode_lurah`,`nama_lurah`,`jumlah_sd`) values ('LR01','Pauah',4),('LR02','Katapiang',12);
...
insert  into `tb_kepegawaian`(`kode_pegawai`,`status_pegawai`) values ('PG-01','PNS'),('PG-02','Honorer');
...
insert  into `tb_matapelajaran`(`kode_matapelajaran`,`nama_matapelajaran`) values ('MP01','Bahasa Indonesia'),('MP02','IPA');
...
insert  into `tb_pangkat`(`kode_pangkat`,`pangkat_kode_golongan`) values ('P01','GL02'),('P02','GL01');
...
insert  into `tb_sekolah`(`kode_sekolah`,`nama_sekolah`,`alamat_sekolah`,`telp_sekolah`,`jml_guru_honor`,`jml_guru_pns`,`jml_siswa_lk`,`jml_siswa_pr`,`kode_lurah_sekolah`) values ('SKL1','SDN 01','Padang barat','08123123',5,8,55,45,'LR01'),('SKL2','SDN 31','Paguah','0845764',3,7,53,33,'LR02');
...
insert  into `tb_user`(`username`,`password`,`hakakses`) values ('01','202cb962ac59075b964b07152d234b70','admin'),('bos','202cb962ac59075b964b07152d234b70','bos');
